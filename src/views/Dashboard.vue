<template>
  <div>
    <NavBar />
    <div class="container">
      <h1 class="mt-3">Bids</h1>
      <hr>
      <div class="row">
        <div class="col-lg-3 mb-3">
          <div class="list-group">
            <router-link to="/dashboard" class="list-group-item active disabled">Bids</router-link>
            <router-link to="/winnings" class="list-group-item">Winnings</router-link>
